...
CREATE TABLE `album_sanatci` (
  ...
  PRIMARY KEY (`album_id`,`sanatci_id`),
  KEY `keyf_sanatci_idx` (`sanatci_id`),
  CONSTRAINT `album_sanatckeyfi_album` FOREIGN KEY (`album_id`) REFERENCES `album` (`album_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `album_sanatckeyfi_sanatci` FOREIGN KEY (`sanatci_id`) REFERENCES `sanatci` (`sanatci_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `album_sanatci` VALUES (4,1),(3,2),(5,3),(6,4),(7,5),(2,6),(1,7);
